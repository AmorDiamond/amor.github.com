/**
 * Created by yulinmufeng on 2018/05/14.
 */
...
$(function () {
    ...
    var xcjChart1 = echarts.init(document.getElementById("xcjItem1"));

  var dataAxis = ['2015','2016','2017'];
  var data = [69, 67, 68];
  ...
  var option1 = {
    ...
    // var maxData = 20000000;
    var xcjChart2 = echarts.init(document.getElementById("xcjItem2"));
    var option2 = {
        title: {
          text: '入住人次',
          left: 'center',
        ...
        series: [{
            ...
            data: [ 16010545, 1368799, 15735259],
            // markLine: {
            //     symbol: 'none',
            //     label: {
            //         normal: {
